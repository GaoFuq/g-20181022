...
import com.code.clkj.menggong.server.broadcast.BroadcastManager;
import com.code.clkj.menggong.server.pinyin.CharacterParser;
import com.code.clkj.menggong.server.response.ContactNotificationMessageData;
...
import static com.code.clkj.menggong.R.string.Login;
