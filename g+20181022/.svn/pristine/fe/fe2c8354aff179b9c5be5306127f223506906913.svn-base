...
public class ErrorLayout extends LinearLayout implements
    ...
    public void setAllHint(boolean allHint) {
        isAllHint = allHint;
    }

    boolean isAllHint = false;
        ...
        case HIDE_LAYOUT:
            ...
            case NODATA:
                if(mErrorState==5){
                    ...
                    if (NetUtil.isNetConnected(getContext())) {
                        tv.setText(R.string.error_view_load_error_click_to_notconext_shoucang);
                        img.setBackgroundResource(R.mipmap.shoucang);
                    } else {
                        tv.setText(R.string.error_view_network_error_click_to_refresh);
                        img.setBackgroundResource(R.mipmap.ic_page_icon_network);
                    }
               ...
               if(mErrorState==6){
                   ...
                   if (NetUtil.isNetConnected(getContext())) {
                       tv.setText(R.string.error_view_load_error_click_to_notconext_message);
                       img.setBackgroundResource(R.mipmap.xiaoximessage);
                   } else {
                       tv.setText(R.string.error_view_network_error_click_to_refresh);
                       img.setBackgroundResource(R.mipmap.ic_page_icon_network);
                   }
                ...
                mErrorState=NODATA;
                if (NetUtil.isNetConnected(getContext())) {
                    tv.setText(R.string.error_view_load_error_click_to_notconext);
                    img.setBackgroundResource(R.mipmap.content_emaly);
                } else {
                    tv.setText(R.string.error_view_network_error_click_to_refresh);
                    img.setBackgroundResource(R.mipmap.ic_page_icon_network);
                }
