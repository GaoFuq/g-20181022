...
public class TempWXPayHelper {
    ...
    public TempWXPayHelper(Context context, String wxAppId, String wxkey, String wxmchid, String WXNotifyUrl, String payMoney, String goodsName, String goodsDetail, String out_tradNO){
        mContext = context;
...
//            return xmlstring;
    ...
    private String genPackageSign(List<NameValuePair> params) {
        ...
        Log.e("TempWXPayHelperSign",packageSign);
        return packageSign;
    }
