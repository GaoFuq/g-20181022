...
import com.code.clkj.menggong.adapter.FaceVPAdapter;
...
public class GiftPanelControl {
    ...
    public interface GiftListener {
        void getGiftInfo(String gifTid, String giftPic, String giftName, String giftPrice);
    }
...
/*    private void intitLandscapeGift() {
    ...
    private void initPortraitGift() {
        ...
        expressionUtil.setGiftClickListener(new ExpressionUtil.GiftClickListener() {
            @Override
            public void onClick(int position,String gifTid, String giftPic, String giftName, String giftPrice) {
                if (giftListener != null) {
                    giftListener.getGiftInfo(gifTid,giftPic, giftName, giftPrice);
                }
            }
        });
    }
