...
import com.code.clkj.menggong.widget.CenterView;
...
public abstract class BaseVideoController extends FrameLayout {
    ...
    protected void slideToChangePosition(float deltaX) {
        ...
        if (position > currentPosition) {
            mCenterView.setIcon(R.mipmap.ic_action_fast_forward);
        } else {
            mCenterView.setIcon(R.mipmap.ic_action_fast_rewind);
        }
    ...
    protected void slideToChangeBrightness(float deltaY) {
        ...
        mCenterView.setIcon(R.mipmap.ic_action_brightness);
    ...
    protected void slideToChangeVolume(float deltaY) {
        ...
        if (index < 0) {
            mCenterView.setIcon(R.mipmap.ic_action_volume_off);
            index = 0;
        } else {
            mCenterView.setIcon(R.mipmap.ic_action_volume_up);
        }
