...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    private LinearLayout mMBtn_Cancel;
    ...
    private void initViews() {
        ...
        mMBtn_Cancel = (LinearLayout) findViewById(R.id.mBtn_Cancel);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
           ...
           //     viewholder.dialogItemButton.setTextColor(mFirstItemColor);
             ...
             //   viewholder.dialogItemButton.setTextColor(mFirstItemColor);
                viewholder.imageview.setImageResource(R.mipmap.act_personal_info_take_pic_icon);
                viewholder.dialogItemButton.setText("拍照上传");
             //   viewholder.dialogItemButton.setBackgroundResource(R.drawable.select_dialog_item_bg_top);
            } else if (position == mStrings.size() - 1) {
                viewholder.dialogItemButton.setText("从相册选择");
              //  viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.imageview.setImageResource(R.mipmap.act_personal_info_choose_pic_icon);
