 ...
 */
public class PLVideoViewActivity1 extends VideoPlayerBaseActivity implements ViewActLookLiveDetailsI{
...
//    private MediaController mMediaController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pl_video_view1);
...
//        mVideoView.setMediaController(mMediaController);
    ...
    private void showToastTips(final String tips) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(PLVideoViewActivity1.this, tips, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
    ...
    protected Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (!Utils.isNetworkAvailable(PLVideoViewActivity1.this)) {
                sendReconnectMessage();
                return;
            }
            mVideoView.setVideoPath(mVideoPath);
