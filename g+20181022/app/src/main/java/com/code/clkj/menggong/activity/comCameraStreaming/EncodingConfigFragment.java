...
public class EncodingConfigFragment extends ConfigFragment {
    public static final String[] VIDEO_SIZE_PRESETS = {
    ...
    public static final String[] AUDIO_QUALITY_PRESETS = {
    ...
    public static final String[] WATERMARK_SIZE_PRESETS = {
            "SMALL",
            "MEDIUM",
            "LARGE",
    };
    ...
    public static final String[] WATERMARK_LOCATION_PRESETS = {
            "NORTH-WEST",
            "NORTH-EAST",
            "SOUTH-EAST",
            "SOUTH-WEST",
    ...
    public EncodingConfig buildEncodingConfig() {
