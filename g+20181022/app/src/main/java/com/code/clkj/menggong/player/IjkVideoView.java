package com.code.clkj.menggong.player;
...
import com.code.clkj.menggong.listener.VideoListener;
import com.code.clkj.menggong.util.Constants;
import com.code.clkj.menggong.util.NetworkUtil;
import com.code.clkj.menggong.util.WindowUtil;
import com.code.clkj.menggong.widget.ResizeSurfaceView;
import com.code.clkj.menggong.widget.ResizeTextureView;
import com.code.clkj.menggong.widget.StatusView;
...
//    private List<ViedioDetail> mVideoModels=new ArrayList<>();//列表播放数据
...
//    }
    ...
    /**
     * 启用{@linkAndroidMediaPlayer},如不调用默认使用 {@link IjkMediaPlayer}
     */
...
//     */
//  //  ,int position
//    public IjkVideoView setVideos(List<ViedioDetail> videoModels) {
...
//        ViedioDetail videoModel = mVideoModels.get(mCurrentVideoPosition);
//        if (videoModel != null) {
//            mCurrentUrl = videoModel.getMgooAppVideo();
...
//        if (mlistener != null) mlistener.onItemClick(mVideoModels.get(mCurrentVideoPosition).getMgooAppVideo(), mCurrentVideoPosition);
