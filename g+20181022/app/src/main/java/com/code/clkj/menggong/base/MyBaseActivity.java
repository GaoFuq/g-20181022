...
public abstract class MyBaseActivity extends FragmentActivity implements OnDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTop= (Toolbar) super.findViewById(R.id.toolbar_top);

        toolbarTop.setBackgroundColor(getResources().getColor(com.lf.tempcore.R.color.white));
        toolbarTop.setNavigationIcon(com.lf.tempcore.R.mipmap.gg_back_d);

        mTitle.setText("技术支持");
        mBtnBackDrawable = getResources().getDrawable(R.mipmap.gg_back_d);
...
//    }
    ...
    @Override
    public Object doInBackground(int requestCode, String id) throws Exception {
        return null;
    }
