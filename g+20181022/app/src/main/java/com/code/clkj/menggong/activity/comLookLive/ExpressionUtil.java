...
import com.code.clkj.menggong.activity.comLookLive.gif.AnimatedGifDrawable;
import com.code.clkj.menggong.activity.comLookLive.gif.AnimatedImageSpan;
import com.code.clkj.menggong.adapter.FaceGVAdapter;
...
*/
        ...
        mGvAdapter.setOnItemClickListener(new FaceGVAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, GiftModel giftModel, int position) {
                try {
                    ...
                    mGvAdapter.notifyDataSetChanged();
                    if (giftClickListener != null) {
                        giftClickListener.onClick(position,gifTid, giftPic, pngStr, giftPrice);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public interface GiftClickListener {
        void onClick(int position, String gifTid, String giftPic, String giftName, String giftPrice);
    }
