...
public class TempTimeUtil extends CountDownTimer {
	private TextView tv;
	private String finishString = "重新获取验证码";
	private String tickString   =  "%d秒后重新获取";
	...
	public void onTick(long millisUntilFinished) {
		...
		if (tickString.contains("%d"))
		tv.setText(String.format(tickString,millisUntilFinished/1000));
