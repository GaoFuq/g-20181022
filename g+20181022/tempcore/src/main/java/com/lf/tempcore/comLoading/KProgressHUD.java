...
package com.lf.tempcore.comLoading;
...
public class KProgressHUD {
    ...
    public KProgressHUD hintView(boolean isHint) {

        if (mProgressDialog!=null&&isHintProView!=isHint){
            mProgressDialog.hintView(isHint);
        }
        isHintProView = isHint;
        return this;
    }
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void initViews() {
            background = (BackgroundLayout) findViewById(R.id.background);
        ...
        public void hintView(boolean hint){
            if (background!=null){
                background.setVisibility(isHintProView?View.INVISIBLE:View.VISIBLE);
            }
            if (getWindow().getAttributes()!=null)
                getWindow().getAttributes().dimAmount = hint? 0:mDimAmount;
